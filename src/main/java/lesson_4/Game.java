...
public class Game {
    public static void main(String[] args) {
        ...
        if (choice >= 1 && choice <= 6) {
            switch (choice) {
                case 1: myHero = warriorOne; break;
                case 2: myHero = warriorTwo; break;
                case 3: myHero = mageOne;   break;
                case 4: myHero = mageTwo;  break;
                case 5: myHero = rogueOne;  break;
                case 6: myHero = rogueTwo;  break;
                default:
